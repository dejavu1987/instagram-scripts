...
// @grant        GM_addStyle
// ==/UserScript==
GM_addStyle('.auto-insta-ui {position: fixed; right:0; bottom:0; z-index: 99999; background: #fff; padding: 1rem;}');
(function () {
    'use strict';
    ...
    const autoLikeList = () => {
        ...
        const likeInterval = setInterval(() => {
            const nextLike = document.querySelectorAll('.fr66n button [aria-label=Like]')[0];
    ...
    autoInstaUI.appendChild(createUIButton('Clear current task', clearCurrentTask));
